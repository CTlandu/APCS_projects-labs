/* Project 6-1: alternative constructors on p197 have been added to Student.java
...
public class Student{
	...
	*/
	...
	public Student(String nm, int t1, int t2, int t3) {
		name = nm;			// earlier version on p196 (unchanged)
		test1 = t1;
		test2 = t2;
		test3 = t3;
	}
	...
	/*	name = s.name;		// earlier version on p196 
		test1 = s.test1;
		test2 = s.test2;
		test3 = s.test3;
	*/
